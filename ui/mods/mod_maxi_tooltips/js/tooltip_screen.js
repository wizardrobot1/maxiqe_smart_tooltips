...
MaxiTooltips.Hooks.TooltipModule_addHeaderDescriptionDiv = TooltipModule.prototype.addHeaderDescriptionDiv;
TooltipModule.prototype.addHeaderDescriptionDiv = function(_parentDIV, _data)
{
	var ret = MaxiTooltips.Hooks.TooltipModule_addHeaderDescriptionDiv.call(this, _parentDIV, _data);
...
MaxiTooltips.Hooks.TooltipModule_addContentTextDiv = TooltipModule.prototype.addContentTextDiv;
TooltipModule.prototype.addContentTextDiv = function(_parentDIV, _data, _isChildRow, _isParentFullWidth)
{
	var ret = MaxiTooltips.Hooks.TooltipModule_addContentTextDiv.call(this, _parentDIV, _data, _isChildRow, _isParentFullWidth);
	if (ret === null || _data.rawHTMLInText !== true )
		return ret;
